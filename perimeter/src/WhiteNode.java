/**
 * A class to represent a white quadtree node in the image. A white node represents a block of an
 * image that contains only 0's.
 **/
public class WhiteNode extends QuadTreeNode {
  ...
  /**
   * Compute the total perimeter of a white node in a binary image that is represented as a quadtree
   * using Samet's algorithm.
   * 
