...
/**
 * A class that represents a voronoi diagram. The diagram is represnted as a binary tree of points.
 **/
public class Vertex extends Vec2 {
  ...
  /**
   * Recursive delaunay triangulation procedure Contains modifications for axis-switching division.
   **/
  public EdgePair buildDelaunay(Vertex extra) {
    ...
    if (getRight() != null && getLeft() != null) {
      ...
      retval =
          Edge.doMerge(delleft.getLeft(), delleft.getRight(), delright.getLeft(),
              delright.getRight());
