...
/**
 * Vector Routines from CMU vision library. They are used only for the Voronoi Diagram, not the
 * Delaunay Triagulation. They are slow because of large call-by-value parameters.
 **/
public class Vec2 {
  double x, y;
  double norm;
  ...
  /**
   * cprod: forms triple scalar product of [u,v,k], where k = u cross v (returns the magnitude of u
   * cross v in space)
   **/
