 ...
 * <p>
 * <cite> G. Lomow , J. Cleary, B. Unger, and D. West. "A Performance Study of Time Warp," In SCS
...
public class Health {
  ...
  public static final void main(String args[]) {
    ...
    if (printMsgs) System.out.println("Columbian Health Care Simulator\nWorking...");
    ...
    if (printResult || printMsgs) {
      ...
      System.out.println("Average length of stay:         " + r.totalTime / r.totalPatients
          + " time units");
