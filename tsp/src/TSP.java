...
/**
 * A Java implementation of the <tt>tsp</tt> Olden benchmark, the traveling salesman problem.
 * <p>
 * <cite> R. Karp, "Probabilistic analysis of partitioning algorithms for the traveling-salesman
 * problem in the plane." Mathematics of Operations Research 2(3):209-224, August 1977 </cite>
 **/
public class TSP {
  /**
  ...
  public static void main(String args[]) {
    ...
    if (printMsgs) System.out.println("Building tree of size " + cities);
    ...
    while (i < args.length && args[i].startsWith("-")) {
      ...
      if (arg.equals("-c")) {
        if (i < args.length)
          ...
          throw new Error("-c requires the size of tree");
