 ...
 * <p>
 * Treeadd is a very simple program that performs a recursive depth first traversal of a binary tree
 * and sums the value of each element in the tree. We initialize the elements in the tree to contain
 * '1'.
 **/
    ...
    while (i < args.length && args[i].startsWith("-")) {
      ...
      if (arg.equals("-l")) {
        if (i < args.length) {
          ...
          throw new RuntimeException("-l requires the number of levels");
