...
public final class BiGraph {
  ...
  /**
   * Create the bi graph that contains the linked list of e and h nodes.
   * 
  ...
  /**
   * Update the field values of e-nodes based on the values of neighboring h-nodes and vice-versa.
   **/
  public void compute() {
